...
include::{presentationSnippets}/error-example/curl-request.adoc[]
...
include::{presentationSnippets}/subset-example/curl-request.adoc[]
...
===== Example request (json)
include::{presentationSnippets}/version-example/curl-request.adoc[]
...
//
//===== Example request
//include::{presentationSnippets}/codes-example/curl-request.adoc[]
//
//===== Example response
...
===== Example request
include::{presentationSnippets}/codes-at-example/curl-request.adoc[]
...
//include::{presentationSnippets}/range-example/curl-request.adoc[]
...
//include::{presentationSnippets}/range-extended-example/curl-request.adoc[]
...
include::{presentationSnippets}/language-example/curl-request.adoc[]
